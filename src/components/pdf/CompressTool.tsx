...
export function CompressTool({ pdfs, status, onCompress, result }: CompressToolProps) {
  ...
  const handleExecute = async (e: React.FormEvent) => {
    ...
    await onCompress(selectedId[0], outputFilename.endsWith('.pdf') ? outputFilename : `${outputFilename}.pdf`)
  }
